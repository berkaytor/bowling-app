...
describe ('Controls', () => {
  ...
  it('should not display summary button before game over', () => {
    const gameOver = false;
    const lastRoll = 3;
    const rolls = 10;
    const wrapper = shallow(
    ...
    expect(wrapper.find('.Summary').exists()).toEqual(false);
  });

  it('should display summary button when game is over', () => {
    const gameOver = true;
    const lastRoll = 3;
    const rolls = 20;
    const wrapper = shallow(
    ...
    expect(wrapper.find('.Summary').exists()).toEqual(true);
  });

  it('should not display summary content before game over', () => {
    const gameOver = false;
    const lastRoll = 3;
    const rolls = 10;
    const wrapper = shallow(
    ...
    wrapper.setState({ summary: 'Test summary' });
    expect(wrapper.find('.SummaryContainer').exists()).toEqual(false);
  });

  it('should display summary content when game is over', () => {
    const gameOver = true;
    const lastRoll = 3;
    const rolls = 20;
    const wrapper = shallow(
